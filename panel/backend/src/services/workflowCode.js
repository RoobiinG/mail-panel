...
const PRUEFUNG_AUSWERTEN = String.raw`// PANEL:THEMEN v1
...
if (themen.aktiv) {
  ...
  const neuRegel = themen.neue_ordner
    ? '- Passt keiner davon und das Thema kommt erkennbar oefter vor, antworte "NEU:<Ordnername>". Der Name ist ein einzelnes deutsches Wort, hoechstens 20 Zeichen, nur Buchstaben, Zahlen, Leerzeichen und Bindestriche.'
    : '- Neue Ordner sind nicht erlaubt. Passt keiner der vorhandenen, setze null.';
  themenBlock = '\n\nVorhandene Themen-Ordner:\n' + liste
    + '\n\nBestimme zusaetzlich das Feld "ordner":\n'
    + '- Passt einer der vorhandenen Ordner zum Inhalt, nimm ihn genau so, wie er oben steht.\n'
    + neuRegel + '\n'
    + '- Bist du unsicher oder passt nichts, setze null. Lieber null als geraten.\n'
    + '- "konfidenz" ist deine Sicherheit von 0.0 bis 1.0.';
}
...
// ─── "Antwort parsen" ────────────────────────────────────────────────────────
const ANTWORT_PARSEN = String.raw`// PANEL:THEMEN v1
...
const BLACKLIST_QUARANTAENE = String.raw`// PANEL:THEMEN v1
...
// ─── "Virus: Quarantäne" ─────────────────────────────────────────────────────
const VIRUS_QUARANTAENE = String.raw`// PANEL:THEMEN v1
